...
#create machine one label
        ...
        self.portOne = portOneButton.text
        #create machine one baudrate
        baudrateOneButton = QLineEdit("112500")
        self.baudrateOne = baudrateOneButton.text
...
#create machine two label
        ...
        self.portTwo = portTwoButton.text

        #create machine two baudrate
        baudrateTwoButton = QLineEdit("112500")
        self.baudrateTwo = baudrateTwoButton.text
